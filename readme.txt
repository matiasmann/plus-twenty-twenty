...
Twenty Twenty theme is awesome. What if we make it awesomer? Twenty Twenty Plus provides lots of options to customize the theme use the Customizer. 

== Description ==

Awesome options using WordPress Customizer. Made and Supported by real people.

What is Customizable right now?
...
We try to answer all questions - free or premium - within 48 hours. We know whats is like to be stucked with something =)
...
== Screenshots ==
1. Leave default Copyright text
2. Set your own text
